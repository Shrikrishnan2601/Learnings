...
public class Call extends BaseClass {
	...
	sleep(8000);
	WebElement element = xpathLocator("//input[@id='order_no']");
	String s=attributeGet(element);
	System.out.println(s);
	appendDataToExcel("D:\\Krishna\\JAVA\\Krishna\\ExcelFiles\\adascr1.xlsx", "Sheet1", 3, 4, s);
	driver.quit();
	}
}
